...
mkdir -p $BASE_PATH/libmicroautoware/microros_include
cp -R firmware/build/include/* $BASE_PATH/libmicroautoware/microros_include/
...
for var in ${INCLUDE_ROS2_PACKAGES}; do
    if [ -d "$BASE_PATH/libmicroautoware/microros_include/${var}/${var}" ]; then
        rsync -r $BASE_PATH/libmicroautoware/microros_include/${var}/${var}/* $BASE_PATH/libmicroautoware/microros_include/${var}
        rm -rf $BASE_PATH/libmicroautoware/microros_include/${var}/${var}
    fi
done
...
sudo chmod -R 777 $BASE_PATH/libmicroautoware/microros_include/
